...
export class ErrorBoundary extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div
        role="alert"
        className="min-h-[50vh] grid place-items-center px-4 py-16 font-sans text-center"
      >
        <div className="max-w-md">
          ...
          <p className="text-sm text-[#483828]/75 mt-2">
            The rest of the shop is fine. Reloading usually fixes it, and we
            have been told about the problem.
          </p>
